...
public class StandaloneDirectoryClient implements DirectoryClient {
  ...
  @Override
  public Map<String, Object> stats(DirectoryRequest drequest) throws IOException {
    List<String> classExpr = drequest.getClassSelectors();
    List<Map<String, String>> labelsExpr = drequest.getLabelsSelectors();

    final DirectoryStatsRequest request = new DirectoryStatsRequest();
    request.setTimestamp(System.currentTimeMillis());
    request.setClassSelector(classExpr);
    request.setLabelsSelectors(labelsExpr);
